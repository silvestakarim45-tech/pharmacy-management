...
<html>
<head>
    <title>Daily Report - Pharmacy Management</title>
...
<div class="admin-panel">
    ...
    <div class="sidebar">
        ...
        <div class="sidebar-menu">
            <ul>
                ...
                <li><a href="deily_report.php" class="active"><i class="fas fa-chart-line"></i> <span>Ripoti ya Siku</span></a></li>
    ...
    <div class="main-content">
        ...
        <div class="container">
            <div class="header">
                <h2>Mauzo yote ya tarehe: <?php echo date('Y-m-d'); ?></h2>
            </div>
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?php echo date('H:i:s', strtotime($row['sale_date'])); ?></td>
                    </tr>
                    <?php
                    }
                    ?>
